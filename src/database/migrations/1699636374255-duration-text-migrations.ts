...
export class DurationTextMigrations1699636374255 implements MigrationInterface {
    name = 'DurationTextMigrations1699636374255'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`exam\` ADD \`duration\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`exam_details\` DROP COLUMN \`duration\``);
        await queryRunner.query(`ALTER TABLE \`exam_details\` ADD \`duration\` time NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`exam\` DROP COLUMN \`duration\``);
        await queryRunner.query(`ALTER TABLE \`exam\` ADD \`duration\` time NULL DEFAULT 'NULL'`);
