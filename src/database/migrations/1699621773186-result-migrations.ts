...
export class ResultMigrations1699621773186 implements MigrationInterface {
    name = 'ResultMigrations1699621773186'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`result\` (\`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`created_by\` varchar(255) NULL, \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`updated_by\` varchar(255) NULL, \`is_active\` tinyint NOT NULL DEFAULT 1, \`id\` varchar(36) NOT NULL, \`exam_id\` varchar(255) NOT NULL, \`total_questions\` int NOT NULL DEFAULT '0', \`correct_answers\` int NOT NULL DEFAULT '0', \`total_marks\` int NOT NULL DEFAULT '0', \`score\` int NOT NULL DEFAULT '0', \`candidate_id\` varchar(255) NOT NULL, \`attempt_id\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
